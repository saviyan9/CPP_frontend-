...
function Signup() {
    ...
    const submitSignupForm = (e) => {
        if (formData.email !== '' && formData.firstName !== '' && formData.lastName !== '' && formData.password !== '') {
            ...
            axios.post(constant.API_URL + '/api/user/register', formdata, {
                headers: {
                ...
                .then(res => {
                    ...
                    if (res.status === 200) {
                        ...
                        axios.post(constant.API_URL+'/api/user/getuser', formdata, {
                            headers: {
                                'Content-Type': 'application/json',
                            },
                        })
            ...
            <div className='signup_container'>
                ...
                <div className='sp_form_and_button'>
                    <form >
                        ...
                        <div className='inputField'>
                            <TextField className='inputField' fullWidth id="outlined-basic" value={formData.location} onChange={handLocationchange} label="Address Location*" variant="outlined" />
                        </div>
